...
export type ResolversTypes = {
  ...
  Session: ResolverTypeWrapper<
    ResolversInterfaceTypes<ResolversTypes>["Session"]
  >;
...
export type ApiKeyResolvers<
  ...
  ParentType extends ResolversParentTypes["ApiKey"] =
    ResolversParentTypes["ApiKey"],
> = {
...
export type BucketResolvers<
  ContextType = GqlApiCtx,
  ParentType extends ResolversParentTypes["Bucket"] =
    ResolversParentTypes["Bucket"],
> = {
  _id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
...
export type SessionGhostResolvers<
  ContextType = GqlApiCtx,
  ParentType extends ResolversParentTypes["SessionGhost"] =
    ResolversParentTypes["SessionGhost"],
> = {
  _id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
  created_at?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  updated_at?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
...
export type SessionNormalResolvers<
  ContextType = GqlApiCtx,
  ParentType extends ResolversParentTypes["SessionNormal"] =
    ResolversParentTypes["SessionNormal"],
> = {
  _id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
  active_bucket?: Resolver<
    Maybe<ResolversTypes["Bucket"]>,
    ParentType,
    ContextType
  >;
  active_bucket_id?: Resolver<
...
> = {
  ...
  sessions?: Resolver<
    Array<ResolversTypes["SessionNormal"]>,
    ParentType,
    ContextType
  >;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
